...
def main():
    ...
    game = Game.Game(boardSize=board_size)
    ...
    while not (num_of_players>=num_of_bots and num_of_bots>=0):
        num_of_bots = int(input("Illegal number of computer bots. Try again.\nHow many computer bots are playing? (from 0 to " + str(num_of_players) + "): "))
    ...
    game.intializedGame(order_player_game) # TODO: complete this function
